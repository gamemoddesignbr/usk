#!/usr/bin/env python3
"""
logo_tool2.py — μsk PicoFly Logo Replacement Tool

Same as logo_tool.py with one addition: wait messages before compression steps.
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
examples:
  python logo_tool2.py extract
  python logo_tool2.py convert my_logo.png preview.png
  python logo_tool2.py convert my_logo.png --invert   # for dark-bg images
  python logo_tool2.py inject  my_logo.png
  python logo_tool2.py inject  my_logo.png --payload ../payload.h
""",
    )
